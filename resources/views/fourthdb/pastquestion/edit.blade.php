            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-success" style="opacity: .8">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/fourthdbcoursequestionupdate', [$question->id, $courseid]) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-lg-8">
                                    <textarea id="text" cols="100" rows="50" class="form-control" name="text" value="" required autofocus>{{$question->text}}</textarea>

                    ...
                    <div class="panel-body">
                        @if($questions != null)
                            @foreach ($questions as $question)
                                <a href="{{route('thirddbcoursequestiondetail', [$note->id, $courseid])}}"><h4>{{$note->title}} </h4> </a>&nbsp&nbsp <a href="{{url('/thirddbcoursequestionedit', [$note->id, $courseid])}}">Update</a>&nbsp <a href="{{url('/thirddbcoursequestiondelete', [$note->id, $courseid])}}">Delete</a>
                            @endforeach

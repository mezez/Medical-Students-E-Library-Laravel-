                    ...
                    <div class="panel-body">
                        @if($courses != null)
                            ...
                            @foreach ($courses as $course)<div class="well">
                                <a href="{{route('secmbcoursecontent', [$course->id])}}"><h4>{{$course->title}} </h4> </a>&nbsp&nbsp <a href="{{route('secmbcourseedit', [$course->id])}}">Update</a>&nbsp <a href="{{route('secmbcoursedelete', [$course->id])}}">Delete</a>
                                </div>
                            @endforeach
                         @else

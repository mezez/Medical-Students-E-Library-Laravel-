                ...
                <div class="panel panel-success" style="opacity: .8">
                    ...
                    <div class="panel-body">
                        ...
                        <br>
                            ...
                            <a href="{{route('secmbcoursenotelist', [$courseid])}}"> <div class="col-lg-4 well" style="padding:4%; border-bottom: 1px solid #0091B2">
                                    <h3>Second MBBS Notes</h3>
                                    Click to see more...
                                </div></a>
                            <a href="{{route('secmbcoursequestionlist', [$courseid])}}"><div class="col-lg-4  well" style="padding:4%; border-bottom: 1px solid #0091B2">

                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    ...
                                    <a href="{{ url('/#') }}">Add Fifth MBBS Course</a>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="{{ url('/#') }}">Add Second DBS Course</a>
                                    <a href="{{ url('/#') }}">Add Third DBS Course</a>
                                    <a href="{{ url('/#') }}">Add Fourth DBS Course</a>
                                    <a href="{{ url('/#') }}">Add Fifth DBS Course</a>

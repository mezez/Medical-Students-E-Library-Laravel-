        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-success" style="opacity: .8">
                    <div class="panel-heading">Third MBBS Contents</div>
                    ...
                    <div class="panel-body">
                        ...
                        <br>
                            ...
                            <a href="{{route('thirdmbcoursenotelist', [$courseid])}}"> <div class="col-lg-4 well" style="padding:4%; border-bottom: 1px solid #0091B2">
                                    <h3>Third MBBS Notes</h3>
                                    Click to see more...
                                </div></a>
                            <a href="{{route('thirdmbcoursequestionlist', [$courseid])}}"><div class="col-lg-4  well" style="padding:4%; border-bottom: 1px solid #0091B2">
